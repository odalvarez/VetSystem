...
public interface ISpeciesRepository
{
    ...
    Task<int>                   CountPatientsByIdAsync(Guid speciesId, CancellationToken ct = default);
    Task<Dictionary<Guid, int>> GetPatientCountsByIdAsync(CancellationToken ct = default);
